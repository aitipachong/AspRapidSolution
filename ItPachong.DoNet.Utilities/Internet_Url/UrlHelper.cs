...
namespace ItPachong.DoNet.Utilities.Internet_Url
{
    ...
    public class UrlHelper
    {
        ...
        public static bool IsBase64(string eStr)
        {
            ...
            if (!System.Text.RegularExpressions.Regex.IsMatch(eStr, "^[A-Z0-9/+=]*$", RegexOptions.IgnoreCase))
            {
                return false;
            }
            return true;
        ...
        public static void ParseUrl(string url, out string baseUrl, out NameValueCollection nvc)
        {
            ...
            // 开始分析参数对    
            System.Text.RegularExpressions.Regex re = new System.Text.RegularExpressions.Regex(@"(^|&)?(\w+)=([^&]+)(&|$)?", RegexOptions.Compiled);
