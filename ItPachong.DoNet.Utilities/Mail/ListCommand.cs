        ...
        protected override ListResponse CreateResponse(byte[] buffer)
        {
            ...
            if (IsMultiline)
            {
                ...
                foreach (string line in lines)
                {
                    ...
                    items.Add(new Pop3ListItem(System.Convert.ToInt32(values[0]),
                        System.Convert.ToInt64(values[1])));
                }
            ...
            else
            {
                ...
                items.Add(new Pop3ListItem(System.Convert.ToInt32(values[1]), System.Convert.ToInt64(values[2])));
