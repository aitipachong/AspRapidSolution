    ...
    public class PopConfig
    {
        ...
        public PopSetting PopSetting
        {
            get
            {
                ...
                popSetting.Port = System.Convert.ToInt32(doc.DocumentElement.SelectSingleNode("Port").InnerText);
                popSetting.UseSSL = System.Convert.ToBoolean(doc.DocumentElement.SelectSingleNode("UseSSL").InnerText);
