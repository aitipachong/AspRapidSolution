...
namespace ItPachong.DoNet.Utilities.Mail
{
    ...
    string body, bool isBodyHtml, Encoding encoding, bool isAuthentication, params string[] files)
        ...
        static readonly int smtpPort = System.Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SmtpPort"]);
    ...
    public class SmtpConfig
    {
        ...
        public SmtpSetting SmtpSetting
        {
            get
            {
                ...
                smtpSetting.Authentication = System.Convert.ToBoolean(doc.DocumentElement.SelectSingleNode("Authentication").InnerText);
