using ItPachong.DoNet.Utilities.Mail;
/// <summary>
/// 类说明：Assistant
/// 编 码 人：苏飞
/// 联系方式：361983679  
...
namespace ItPachong.DoNet.Utilities.Mime
{
    /// <summary>
    ...
    public class MimeReader
    {
        ...
        private int ParseHeaders()
        {
            ...
            while (_lines.Count > 0 && !string.IsNullOrEmpty(_lines.Peek()))
            {
                ...
                //previous line.
                if (line.StartsWith(" ") || line.StartsWith(System.Convert.ToString('\t')))
                {
        ...
        private void SetDecodedContentStream()
        {
            switch (_entity.ContentTransferEncoding)
            {
                case System.Net.Mime.TransferEncoding.Base64:
                    _entity.Content = new MemoryStream(System.Convert.FromBase64String(_entity.EncodedMessage.ToString()), false);
                    break;
