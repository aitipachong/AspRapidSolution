...
namespace ItPachong.DoNet.Utilities.Mime
{
    ...
    public static class QuotedPrintableEncoding
    {
        ...
        private static string DecodeLine(string line)
        {
            ...
            System.Text.RegularExpressions.Regex hexRegex = new System.Text.RegularExpressions.Regex(HexPattern, RegexOptions.IgnoreCase);
        ...
        {
            int dec = System.Convert.ToInt32(m.Groups[2].Value, 16);
