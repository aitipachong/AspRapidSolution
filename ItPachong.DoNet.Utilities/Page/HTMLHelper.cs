...
namespace ItPachong.DoNet.Utilities.Page
{
    public class HTMLHelper
    {
        ...
        public static string NoHTML(string Htmlstring)
        {
            ...
            //删除HTML   
            System.Text.RegularExpressions.Regex regex = new System.Text.RegularExpressions.Regex("<.+?>", RegexOptions.IgnoreCase);
        ...
        public string GetHref(string HtmlCode)
        {
            ...
            foreach (Match m in System.Text.RegularExpressions.Regex.Matches(HtmlCode, Reg))
            {
        ...
        public string GetImgSrc(string HtmlCode, string imgHttp)
        {
            string MatchVale = "";
            string Reg = @"<img.+?>";
            foreach (Match m in System.Text.RegularExpressions.Regex.Matches(HtmlCode.ToLower(), Reg))
            {
        ...
        public string GetImg(string ImgString, string imgHttp)
        {
            ...
            foreach (Match m in System.Text.RegularExpressions.Regex.Matches(ImgString.ToLower(), Reg))
            {
        ...
        {
            Html = System.Text.RegularExpressions.Regex.Replace(Html, @">\s+?<", "><");//去除HTML中的空白字符
            Html = System.Text.RegularExpressions.Regex.Replace(Html, @"\r\n\s*", "");
            Html = System.Text.RegularExpressions.Regex.Replace(Html, @"<body([\s|\S]*?)>([\s|\S]*?)</body>", @"<body$1>$2</body>", RegexOptions.IgnoreCase);
            return Html;
        }
        #endregion
        ...
        public static string DelHtml(string s_TextStr, string html_Str)
        {
            ...
            {
                rStr = System.Text.RegularExpressions.Regex.Replace(s_TextStr, "<" + html_Str + "[^>]*>", "", RegexOptions.IgnoreCase);
                rStr = System.Text.RegularExpressions.Regex.Replace(rStr, "</" + html_Str + ">", "", RegexOptions.IgnoreCase);
            }
            return rStr;
        }
        #endregion
