...
namespace ItPachong.DoNet.Utilities.Page
{
    public class PageHelper
    {
        ...
        public static void LockPage(System.Web.UI.Page page, object[] obj)
        {
        ...
        public static void UnLockPage(System.Web.UI.Page page, object[] obj)
        {
            System.Web.UI.Control htmlForm = null;
            foreach (System.Web.UI.Control ctl in page.Controls)
            {
        ...
        private static void LockControl(System.Web.UI.Page page, System.Web.UI.Control ctl)
        {
            //WebControl
        ...
        /// <param name="page"></param>
        /// <param name="ctl"></param>
        private static void UnLockControl(System.Web.UI.Page page, System.Web.UI.Control ctl)
        {
            //WebControl
            if (ctl is Button || ctl is CheckBox || ctl is HyperLink || ctl is LinkButton
                || ctl is ListControl || ctl is TextBox)
        ...
        /// </summary>
        /// <returns></returns>
        public static System.Web.UI.Page GetCurrentPage()
        {
            return (System.Web.UI.Page)HttpContext.Current.Handler;
        }
        ...
        {
            System.Web.UI.Page page = GetCurrentPage();
