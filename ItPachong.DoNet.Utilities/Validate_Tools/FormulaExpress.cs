        ...
        private double CalculateExExpress(string strExpression, EnumFormula ExpressType)
        {
            ...
            switch (ExpressType)
            {
                case EnumFormula.Sin:
                    retValue = Math.Sin(System.Convert.ToDouble(strExpression));
                    break;
                case EnumFormula.Cos:
                    retValue = Math.Cos(System.Convert.ToDouble(strExpression));
                    break;
                case EnumFormula.Tan:
                    retValue = Math.Tan(System.Convert.ToDouble(strExpression));
                    break;
                case EnumFormula.ATan:
                    retValue = Math.Atan(System.Convert.ToDouble(strExpression));
                    break;
                case EnumFormula.Sqrt:
                    retValue = Math.Sqrt(System.Convert.ToDouble(strExpression));
                    break;
                case EnumFormula.Pow:
                    retValue = Math.Pow(System.Convert.ToDouble(strExpression), 2);
                    break;
            }
