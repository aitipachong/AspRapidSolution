...
namespace ItPachong.DoNet.Utilities.Validate_Tools
{
    public class PageValidate
    {
        private static System.Text.RegularExpressions.Regex RegNumber = new System.Text.RegularExpressions.Regex("^[0-9]+$");
        private static System.Text.RegularExpressions.Regex RegNumberSign = new System.Text.RegularExpressions.Regex("^[+-]?[0-9]+$");
        private static System.Text.RegularExpressions.Regex RegDecimal = new System.Text.RegularExpressions.Regex("^[0-9]+[.]?[0-9]+$");
        private static System.Text.RegularExpressions.Regex RegDecimalSign = new System.Text.RegularExpressions.Regex("^[+-]?[0-9]+[.]?[0-9]+$"); //等价于^[+-]?\d+[.]?\d+$
        private static System.Text.RegularExpressions.Regex RegEmail = new System.Text.RegularExpressions.Regex("^[\\w-]+@[\\w-]+\\.(com|net|org|edu|mil|tv|biz|info)$");//w 英文字母或数字的字符串，和 [a-zA-Z0-9] 语法一样 
        private static System.Text.RegularExpressions.Regex RegCHZN = new System.Text.RegularExpressions.Regex("[\u4e00-\u9fa5]");
        ...
        {
            return System.Convert.ToDateTime(dt).ToShortDateString();
        }
        ...
        public static bool isContainSameChar(string strInput, string charInput, int lenInput)
        {
            ...
            {
                System.Text.RegularExpressions.Regex RegNumber = new System.Text.RegularExpressions.Regex(string.Format("^([{0}])+$", charInput));
