using ItPachong.DoNet.Utilities.Regex;
using System;
...
namespace ItPachong.DoNet.Utilities.Validate_Tools
{
    ...
    public static class Tools
    {
        ...
        public static bool IsDate(ref string date)
        {
            ...
            {
                //用转换测试是否为规则的日期字符
                date = System.Convert.ToDateTime(date).ToString("d");
                return true;
            }
            catch
            {
                ...
                if (date.Length == 8)
                {
                    ...
                    //验证合法性
                    if (System.Convert.ToInt32(year) < 1900 || System.Convert.ToInt32(year) > 2100)
                    {
                        return false;
                    }
                    if (System.Convert.ToInt32(month) > 12 || System.Convert.ToInt32(day) > 31)
                    {
                        return false;
                    }

                    //拼接日期
                    date = System.Convert.ToDateTime(year + "-" + month + "-" + day).ToString("d");
                    return true;
                }
                ...
                if (date.Length == 6)
                {
                    ...
                    if (System.Convert.ToInt32(month) > 12)
                    {
                        return false;
                    }

                    //拼接日期
                    date = System.Convert.ToDateTime(year + "-" + month).ToString("d");
                    return true;
                }
                ...
                if (date.Length == 4)
                {
                    ...
                    //拼接日期
                    date = System.Convert.ToDateTime(year).ToString("d");
                    return true;
                }
                #endregion
